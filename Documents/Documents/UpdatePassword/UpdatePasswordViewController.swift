...
protocol UpdatePasswordViewControllerInput: AnyObject {
...
final class UpdatePasswordViewController: UIViewController {
    ...
    private var presenter: UpdatePasswordPresenterInput
    private let mainView = UpdatePasswordView()
    ...
    init(presenter: UpdatePasswordPresenterInput) {
...
extension UpdatePasswordViewController: UpdatePasswordViewControllerInput {
    func resultCheckPassword(_ result: ResultCheckPassword) {
        let notificationCenter = NotificationCenter.default
        switch result {
        case .empty:
