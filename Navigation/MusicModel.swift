...
extension MusicModel {
    static var songList: [MusicModel] = [MusicModel(name: "Pussy boy", artist: "Egor Creed", image: UIImage(named: "music1"), filePath: Bundle.main.url(forResource: "music1", withExtension: "mp3")!),
                                         MusicModel(name: "Дежавю", artist: "kizaru", image: UIImage(named: "music2"), filePath: Bundle.main.url(forResource: "music2", withExtension: "mp3")!),
