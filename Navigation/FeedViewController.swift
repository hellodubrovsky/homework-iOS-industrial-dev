...
final class FeedViewController: UIViewController {
    ...
    @objc private func buttonPostScreenAction() {
    ...
    private func addObserverForView() {
        ...
        notificationCenter.addObserver(self, selector: #selector(buttonPostScreenAction), name: Notification.Name("notificationForButtonPost"), object: nil)
